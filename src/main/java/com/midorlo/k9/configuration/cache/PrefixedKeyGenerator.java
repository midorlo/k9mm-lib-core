...
import com.midorlo.k9.model.cache.PrefixedSimpleKey;
 ...
 * <p>This class is responsible for generating cache keys that are specific to a version of the application by
 * prefixing them with git commit hash.</p>
 ...
 * <p>This case typically occurs in production to ensure zero-downtime updates across a cluster requiring that two
 * different versions of the application have to run concurrently for some time.</p>
 */
@Getter
