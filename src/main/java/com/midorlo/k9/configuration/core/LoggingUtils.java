...
public final class LoggingUtils {
     ...
     * @param customFields a {@link String} object.
     */
    public static void addContextListener(LoggerContext context, String customFields, CoreProperties.Logging properties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        ...
        private LogbackLoggerContextListener(CoreProperties.Logging loggingProperties, String customFields) {
